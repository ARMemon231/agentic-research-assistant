...
# ── Agent builder ──────────────────────────────────────────────────────── 
def build_agent(mistral_api_key: str):
    """
    ...
    Args:
        MistralAI_api_key — passed in from the environment, not hardcoded here.
    ...
    """
        ...
        return {
                ...
                "validation_reason": result.reason, # May be refined/corrected
...
- Reference source titles when mentioning specific facts"""
    ...
    def route_after_validation(state: ResearchState) -> str:
        ...
        return "___end___"  # Special LangGraph key to route to END
