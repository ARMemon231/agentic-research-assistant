...
NODE_DISPLAY = {
    ...
    "analyze_query": "analyzing research strategy",
    "decide_search_strategy": "planning search strategy",
    "web_search": "searching the web",
    "kb_search": "search local knowledge base",
...
def download_pdf(report_id: str):
    ...
    try:
        pdf_bytes = generate_pdf(topic=report["topic"],report_md= report["report_md"],sources=report["sources"],)
    except Exception as e:
